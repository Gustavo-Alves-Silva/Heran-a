...
public class CadastroFilo extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					CadastroFilo frame = new CadastroFilo(null);
	 ...
	 * Create the frame.
	 */
	public CadastroFilo(Reino reino) {
...
//		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { 
					...
					String nomeFilo = txtCadastro.getText();
					Filo filo = new Filo(reino.getNomeReino(),nomeFilo);
					reino.getFilos().add(filo);
					TelaFilosListar A = new TelaFilosListar(reino);
					System.out.println("Filo Cadastrado");
					A.setVisible(true);
					setVisible(false);
