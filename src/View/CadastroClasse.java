...
public class CadastroClasse extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					CadastroClasse frame = new CadastroClasse(null);
	 ...
	 * Create the frame.
	 */
	public CadastroClasse(Filo filo) {
...
//		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { 
					...
					String nomeClasse = txtCadastro.getText();
					Classe classe = new Classe(filo.getNomeReino(),filo.getNomeFilo(),nomeClasse);
					filo.getClasses().add(classe);
					TelaClasseListar A = new TelaClasseListar(filo);
					System.out.println("Classe Cadastrado");
					A.setVisible(true);
					setVisible(false);
