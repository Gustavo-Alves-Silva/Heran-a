...
public class CadastroFamilia extends JFrame {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					CadastroFamilia frame = new CadastroFamilia(null);
	 ...
	 * Create the frame.
	 */
	public CadastroFamilia(Ordem ordem) {
		System.out.println("A"+ordem.getClasse().getOrdens());
...
//		setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { 
					...
					String nomeFamilia = txtCadastro.getText();
					Familia familia = new Familia(ordem.getClasse().getFilo().getReino().getNomeReino(),ordem.getClasse().getNomeFilo(), ordem.getClasse().getNomeClasse(),ordem.getNomeOrdem(), nomeFamilia);
					ordem.getFamilias().add(familia);
					ordemG = ordem;
					TelaFamiliaListar A = new TelaFamiliaListar(ordem);
					System.out.println("Familia Cadastrado");
					A.setVisible(true);
					setVisible(false);
